...
if($OJ_MEMCACHE)
       ...
       if ($row['contest_id']>0) {
        ...
        if(isset($_SESSION['http_judge'])) {
                  $view_status[$i][3].="<form class='http_judge_form' method=post action=admin/problem_judge.php><input type=hidden name=sid value='".$row['solution_id']."'>";
        }
        ...
        if(isset($_SESSION['http_judge'])) {
                 // $view_status[$i][3].="<form id='http_judge_".$row['solution_id']."' class='http_judge' method=post action=admin/problem_judge.php><input type=hidden name=sid value='".$row['solution_id']."'>";
                  $view_status[$i][3].="<select class='http_judge btn input-small' length=2 name=result>";
                  ...
                  $view_status[$i][3].="<input class='http_judge btn input-mini' title='$MSG_Explain' type='text' name='explain'>";
                  $view_status[$i][3].="<input class='http_judge btn input-mini'  type=submit name=manual value='$MSG_OK'>";
        ...
        $view_status[$i][9]=100- $row['lint_error'];
